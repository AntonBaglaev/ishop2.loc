					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								...
								<p>Explore Now</p>
								<h4>
                                    <a data-id="<?=$hit->id;?>" class="add-to-cart-link" href="cart/add?id=<?=$hit->id;?>"><i></i></a> <span class=" item_price"><?=$curr['symbol_left'];?><?=$curr['symbol_right'];?><?=$hit->price * $curr['value'];?></span>
